...
$$\sum_{i=1}^{n} w_ix + b$$
They are exceeding powerful when the dataset is separable by a linear surface. It might not always be useful to model data of any arbitrary complexity with, Hello[@neurify].
